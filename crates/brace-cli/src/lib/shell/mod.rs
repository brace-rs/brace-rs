...
impl Shell {
    ...
    pub fn info<T>(&mut self, message: T) -> Result<(), Error>
    where
        T: Display,
    {
    ...
    pub fn warn<T>(&mut self, message: T) -> Result<(), Error>
    where
        T: Display,
    {
        match self.verbosity {
    ...
    pub fn error<T>(&mut self, message: T) -> Result<(), Error>
    where
        T: Display,
    {
        match self.verbosity {
    ...
    pub fn print<T>(&mut self, message: T) -> Result<(), Error>
    where
        T: Display,
    {
        match self.verbosity {
    ...
    pub fn set_color_choice(&mut self, color: &str) -> Result<(), Error> {
...
impl ShellWriter {
    ...
    fn write(&mut self, message: &dyn Display) -> Result<(), Error> {
        write!(self.stream, "{}", message)?;

        Ok(())
    }

    fn writeln(&mut self, message: &dyn Display) -> Result<(), Error> {
